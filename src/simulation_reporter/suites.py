from ltspice_runner import (
    AC, ACSource, Constant, Noise, Pulse, SimulationCase, Transient, VoltageSource,
)
...
def opamp_standard_suite(input_node: str, output_node: str) -> list[SimulationCase]:
    return [
        SimulationCase(
            VoltageSource("VIN", input_node, "0",
        ...
        SimulationCase(
            ...
            Noise(output=output_node, source="VIN",
                  points=200, start_freq="1", stop_freq="10meg"),
            label="noise",
            plot_vars=None,
        ),
    ]
